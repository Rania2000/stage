...
export class ProjectStartComponent implements OnInit {
    ...
    projectStartImage: Image[] = [
        {
            img: 'https://images.unsplash.com/photo-1598520106830-8c45c2035460?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=667&q=80'
        }
    ]
    projectStartContent: Content[] = [
        {
            title: 'Démarre Votre Projet Avec Nous',
